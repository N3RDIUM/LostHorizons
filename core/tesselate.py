...
def tesselate(quad, segments=100):
    ...
    for y in range(segments + 1):
        for x in range(segments + 1):
            ...
            point2 = (
                p1[0] + (p2[0] - p1[0]) * x / segments + (p4[0] - p1[0]) * (y + 1) / segments,
                p1[1] + (p2[1] - p1[1]) * x / segments + (p4[1] - p1[1]) * (y + 1) / segments,
                p1[2] + (p2[2] - p1[2]) * x / segments + (p4[2] - p1[2]) * (y + 1) / segments
            )
            point3 = (
                p1[0] + (p2[0] - p1[0]) * (x + 1) / segments + (p4[0] - p1[0]) * y / segments,
                p1[1] + (p2[1] - p1[1]) * (x + 1) / segments + (p4[1] - p1[1]) * y / segments,
                p1[2] + (p2[2] - p1[2]) * (x + 1) / segments + (p4[2] - p1[2]) * y / segments
            )
            point4 = (
                p1[0] + (p2[0] - p1[0]) * (x + 1) / segments + (p4[0] - p1[0]) * (y + 1) / segments,
                p1[1] + (p2[1] - p1[1]) * (x + 1) / segments + (p4[1] - p1[1]) * (y + 1) / segments,
                p1[2] + (p2[2] - p1[2]) * (x + 1) / segments + (p4[2] - p1[2]) * (y + 1) / segments
            )
